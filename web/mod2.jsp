...
ResultSet rs=stmt.executeQuery("select *  from STAFF_INFO where email_id='"+fruit+"'");
  while(rs.next())
  {
...
ResultSet rs2=stmt1.executeQuery("select *  from ATTENDANCE_STAFF where email_id='"+fruit+"'");
  while(rs2.next())
  {
  %>
<tr>
